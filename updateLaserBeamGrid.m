...
% Defining the odd functions
Odd_occupied_pixel = 0.9/(1-0.9);
Odd_free_pixel = 0.1/(1-0.1);
...
oddsmap(I2, J2) = oddsmap(I2, J2)*Odd_occupied_pixel;
...
for k=1:length(l)-1 %skip the target pixel
    oddsmap(l(k,1),l(k,2)) = oddsmap(l(k,1),l(k,2))*Odd_free_pixel; % free pixels
end
